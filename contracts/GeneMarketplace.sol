...
contract GeneMarketplace is ZamaEthereumConfig {
    ...
    mapping(address => mapping(uint256 => uint256[])) private offers;

    mapping(address => mapping(uint256 => uint256[])) private ownerOffers;
